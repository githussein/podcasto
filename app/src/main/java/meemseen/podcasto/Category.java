...
public class Category extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(str.equals("technology")) { //technology category
            //Set the title of the activity
            setTitle(R.string.category_tech);

            //ArrayList of the audio files
            final ArrayList<AudioFile> audiosList = new ArrayList<AudioFile>();
        ...
        else if(str.equals("business")) { //business category
            //Set the title of the activity
        ...
        else if(str.equals("health")){  //health category
            //Set the title of the activity
        ...
        else if(str.equals("sports")){  //sports category
            //Set the title of the activity
